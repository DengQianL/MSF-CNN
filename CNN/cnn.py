...
filters = 3
kernel_size = 4
convolution_1d_layer = keras.layers.convolutional.Conv1D(filters, kernel_size, strides=1, padding='same', input_shape=(550,1), activation="relu", name="convolution_1d_layer")
#convolution_layer = keras.layers.convolutional.Conv1D(7, 5, strides=1, padding='same', activation='relu',name="convolution_layer")
